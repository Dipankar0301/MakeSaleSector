...
import AnnualFields from '@salesforce/label/c.Sector_AnnualsFields';

export default class Sector_RelatedlistAnnuals extends LightningElement {
    ...
    connectedCallback()
    {
        var arraylist = AnnualFields.split(",");
        var fieldlist = '';
